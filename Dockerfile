...
# Instala oci8
COPY /var/lib/docker/volumes/localrooot/_data/wwwinstantclient-basic-linux.x64-19.28.0.0.0dbru.zip /tmp/
COPY /var/lib/docker/volumes/localrooot/_data/wwwinstantclient-sdk-linux.x64-19.28.0.0.0dbru.zip /tmp/
